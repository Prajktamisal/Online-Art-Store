...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($user_name) && !empty($password) && !is_numeric($user_name))
		{
			...
			//read from database
			$query = "select * from artist where artist_name = '$user_name' limit 1";
			...
			if($result)
			{
				if($result && mysqli_num_rows($result) > 0)
				{
					...
					if($user_data['password'] === $password)
					{
						...
						$_SESSION['artist_id'] = $user_data['artist_id'];
...
<div class="container">
		<img src="artist.jfif"/>
			<form method="post">
			<lable><h2 style="color:White;">Artist Login</h2></lable>
				...
				<h5><a href="artist_signup.php" style="color:white;">Click to Signup</a><h5>
				<h5><a href="admin_login.php" style="color:white;">Signin As Admin</a><h5><br><br>
			</form>
</div>
</body>
</html>